...
CPTBase.AddConVar("cpt_decals",1)
...
if CLIENT then
	local function CPTBaseMenu_SNPC(panel)
		...
		panel:AddControl("CheckBox",{ Label = "CPTBase SNPCs use CPTBase-Nodegraph?",Command = "cpt_aiusecustomnodes"})
		...
		panel:AddControl("CheckBox",{ Label = "Allow SNPC blood decals?",Command = "cpt_decals"})
